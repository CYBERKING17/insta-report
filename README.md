...
```
```bash
 git clone https://github.com/CYBERKING17/INSTA-REPORT.git
```
```bash
 cd INSTA-REPORT 
```
...
![INSTA-REPORT Screenshot](https://github.com/CYBERKING17/INSTA-REPORT/blob/main/screenshots/IMG_20250715_215721.jpg)
